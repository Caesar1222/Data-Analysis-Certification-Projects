...
df = pd.read_csv('Data Science Certification Projects/Page View Time Series Visualizer/fcc-forum-pageviews.csv', parse_dates=['date'], index_col='date')
...
def draw_box_plot():
    ...
    sns.boxplot(data=df_box, x='month', y='value', ax=ax[1], hue= 'month', order=month_order)
